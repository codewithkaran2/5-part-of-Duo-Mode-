...
function movePlayers() {
  ...
  // Update shield status – toggled via keys (q for Player 1, m for Player 2)
...
/* --------------------------
   SHIELD LOGIC
----------------------------- */
// Fresh shield mechanic: shield decreases when active and recharges when not active.
